                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-red sbold uppercase">Edit News</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            <!-- BEGIN FORM-->
                            <form action="{{route('edit-news-post',[$news->id_news])}}" id="form_sample_2" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="{{csrf_token()}}">
                                <div class="form-body">
                                    <div class="form-group form-md-line-input">
                                        <input type="text" class="form-control" name="title" id="form_control_1" placeholder="Enter your name" value="{{old('title',$news->title_vi_news)}}">
                                    ...
                                    <div class="form-group form-md-line-input">
                                        <textarea class="ckeditor form-control"
                                                  name="content_news"
                                                  rows="6">{{old('content_news',$news->content_news)}}</textarea>
